...
class FilePanel(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller, on_next, on_back=None, footer=None):
    ...
    def _build_ui(self):
        ...
        self._error_label.grid(row=1, column=0, sticky="w", padx=PAD_X, pady=(2, 0))

        # ── Navigation bar (pinned; see gui.page_shell) ───────
